...
define dso_local void @_Z6matmulNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %input, %"class.std::__1::vector"* %weight) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  ...
  %sum = alloca %"class.std::__1::vector.0", align 8
  ...
  %call = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %weight, i64 1) #10
  %call1 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %call) #10
  %conv = trunc i64 %call1 to i32
  store i32 %conv, i32* %n, align 4
  %call2 = call i64 @_ZNKSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEE4sizeEv(%"class.std::__1::vector"* %input) #10
  %conv3 = trunc i64 %call2 to i32
  store i32 %conv3, i32* %m, align 4
  %call4 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %input, i64 1) #10
  %call5 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %call4) #10
...
for.cond:                                         ; preds = %for.inc25, %entry
  ...
  br i1 %cmp, label %bb, label %bb17

for.body:                                         ; preds = %bb
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEEC2Ev(%"class.std::__1::vector.0"* %sum) #10
  store i32 0, i32* %col, align 4
  br label %for.cond7

for.cond7:                                        ; preds = %for.inc21, %for.body
  %i3 = load i32, i32* %col, align 4
  %i4 = load i32, i32* %n, align 4
  %cmp8 = icmp slt i32 %i3, %i4
  br i1 %cmp8, label %bb18, label %bb19

for.body9:                                        ; preds = %bb18
...
for.cond10:                                       ; preds = %for.inc, %for.body9
  ...
  %cmp11 = icmp slt i32 %i5, %i6
  br i1 %cmp11, label %bb20, label %bb21

for.body12:                                       ; preds = %bb20
  %i7 = load i32, i32* %row, align 4
  %conv13 = sext i32 %i7 to i64
  %call14 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %input, i64 %conv13) #10
  %i8 = load i32, i32* %j, align 4
  %conv15 = sext i32 %i8 to i64
  %call16 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call14, i64 %conv15) #10
  %i9 = load i32, i32* %call16, align 4
  %i10 = load i32, i32* %j, align 4
  %conv17 = sext i32 %i10 to i64
  %call18 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %weight, i64 %conv17) #10
  %i11 = load i32, i32* %col, align 4
  %conv19 = sext i32 %i11 to i64
  %call20 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call18, i64 %conv19) #10
  %i12 = load i32, i32* %call20, align 4
  %mul = mul nsw i32 %i9, %i12
  %i13 = load i32, i32* %curr, align 4
  %add = add nsw i32 %i13, %mul
  store i32 %add, i32* %curr, align 4
  br label %for.inc

for.inc:                                          ; preds = %for.body12
  %i14 = load i32, i32* %j, align 4
  %inc = add nsw i32 %i14, 1
  store i32 %inc, i32* %j, align 4
  br label %for.cond10

for.end:                                          ; preds = %bb21
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backERKi(%"class.std::__1::vector.0"* %sum, i32* nonnull align 4 dereferenceable(4) %curr)
  br label %invoke.cont

invoke.cont:                                      ; preds = %for.end
  br label %for.inc21

for.inc21:                                        ; preds = %invoke.cont
  %i15 = load i32, i32* %col, align 4
  %inc22 = add nsw i32 %i15, 1
  store i32 %inc22, i32* %col, align 4
  br label %for.cond7

for.end23:                                        ; preds = %bb19
  call void @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEE9push_backERKS3_(%"class.std::__1::vector"* %agg.result, %"class.std::__1::vector.0"* nonnull align 8 dereferenceable(24) %sum)
  br label %invoke.cont24

invoke.cont24:                                    ; preds = %for.end23
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEED2Ev(%"class.std::__1::vector.0"* %sum) #10
  br label %for.inc25

for.inc25:                                        ; preds = %invoke.cont24
  %i16 = load i32, i32* %row, align 4
  %inc26 = add nsw i32 %i16, 1
  store i32 %inc26, i32* %row, align 4
  br label %for.cond

for.end27:                                        ; preds = %bb17
  store i1 true, i1* %nrvo, align 1
  %nrvo.val = load i1, i1* %nrvo, align 1
  br i1 %nrvo.val, label %bb22, label %bb23

nrvo.unused:                                      ; preds = %bb23
  call void @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEED2Ev(%"class.std::__1::vector"* %agg.result) #10
  br label %nrvo.skipdtor

nrvo.skipdtor:                                    ; preds = %bb22, %nrvo.unused
  ret void
...
bb18:                                             ; preds = %for.cond7
  br label %for.body9

bb19:                                             ; preds = %for.cond7
  br label %for.end23

bb20:                                             ; preds = %for.cond10
  br label %for.body12

bb21:                                             ; preds = %for.cond10
  br label %for.end

bb22:                                             ; preds = %for.end27
  br label %nrvo.skipdtor

bb23:                                             ; preds = %for.end27
